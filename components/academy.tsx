...
export function Academy() {
  return (
    <section id="academy" className="py-24 md:py-28">
      <div className="mx-auto max-w-6xl px-5 md:px-7">
        <SectionHead
          eyebrow="The Padel X Academy"
          title="Structured programs, real coaches."
          sub="Kids, adults, and private 1:1 — every Padel X Pakistan program has a fixed schedule, coach, and group size."
        />
