...
const MAPS_DIRECTIONS_URL =
  "https://www.google.com/maps/dir/?api=1&destination=Block+2,+Clifton,+Karachi,+Pakistan";
const MAPS_EMBED_URL = "https://www.google.com/maps?q=Block+2,+Clifton,+Karachi,+Pakistan&output=embed";

const hours = [{ day: "Monday – Sunday", time: "8:00 AM – 2:00 AM" }];
        ...
        <div className="grid grid-cols-1 gap-4.5 lg:grid-cols-[1fr_0.85fr]">
          ...
          <div className="flex flex-col gap-4.5">
              ...
              <div className="mb-4.5 flex items-start gap-3.5">
                ...
                <div>
                  ...
                  <p className="text-[13.5px] leading-relaxed text-muted">
                    Block 2, Clifton, Karachi, Pakistan
                  </p>
                </div>
              </div>
            ...
            <div className="flex items-center justify-between gap-4 rounded-[18px] border border-border bg-surface p-6.5">
              <div>
                <div className="mb-1 text-[15px] font-bold">Call us</div>
                <p className="text-[13px] leading-relaxed text-muted">0300-7233591 (0300-PADELX1)</p>
              </div>
              <Button size="sm" variant="outline" className="shrink-0" asChild>
                <a href="tel:+923007233591">
