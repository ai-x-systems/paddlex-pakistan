    ...
    <section className="relative overflow-hidden pb-24 pt-28 md:pb-28 md:pt-32">
      ...
      <div className="relative z-10 mx-auto max-w-3xl px-5 text-center md:px-7">
        ...
        <motion.h1
          ...
          className="mb-5 text-[38px] font-black leading-[1.03] tracking-[-0.035em] sm:text-[52px] md:text-[68px]"
        >
        ...
        <motion.p
          ...
          className="mx-auto mb-9 max-w-lg text-[16px] leading-relaxed text-muted md:text-[19px]"
        >
